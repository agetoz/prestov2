...
class Karyawan extends CI_Controller {
	...
	public function index()
	{
		$data = array(
			...
			'data_karyawan' => $this->model->GetKaryawanJab("order by id_kar asc")->result_array(),
		);
	...
	function savedata(){
		$config = array(
			...
			'allowed_types' => 'gif|jpg|jpeg|JPEG|JPG|png',
			'max_size' => '2048',
		...
		if($result == 1){
			...
			header('location:'.base_url().'index.php/karyawan');
		}else{

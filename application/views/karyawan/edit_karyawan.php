          ...
          <section class="col-lg-12">
            ...
            <div class="box">
              ...
              <div class="box-body chat" id="chat-box">
                <!-- chat item -->
                <div class="item">
                  <form role="form" action="<?php echo base_url(); ?>index.php/karyawan/updatekaryawan" method="POST" enctype="multipart/form-data">
                  <div class="col-lg-6">
                ...
                <div class="form-group">
                  ...
                  <a href="<?php echo base_url(); ?>index.php/produk" class="btn btn-warning btn-block btn-flat">Kembali</a>
                </div><!-- /.col -->
               </form>
